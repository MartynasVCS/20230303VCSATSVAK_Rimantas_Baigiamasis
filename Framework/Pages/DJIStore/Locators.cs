...
namespace SeleniumFramework.Pages.DJIStore
{
    internal static class Locators
    {
        internal static class StoreDJIFrontPage
        {
            ...
            internal static string firstDJIMini3ProductLink = "//*[@id='store-main-content']/div[2]/div/div/div/section/div[3]/ul/li[1]/a"; 
            ...
            internal static string officialRefurbished = "//li[contains(@class, 'index-module__dji-nav-item') and contains(@href, '/pages/refurbished')]";
